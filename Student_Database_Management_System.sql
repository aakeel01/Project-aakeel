...
(9,'Suarj','Science','zab@gmail.com','5554640','zab.201','2000-10-03','Male','Maths','8.0','C'),
(10,'Sindhu','Commerce','cde@gmail.com','9984510','cde.202','2000-10-04','Female','Home_science','7.5','C');
...
from student_info
order by grade DESC
where grade = cast ( grade as decimal);
...
select  Stu_name, MAX (gpa)as top_gpa
from student_info
group by Stu_name;
